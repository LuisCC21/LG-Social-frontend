...
let socket
export const PostsPerfil = ({ publicacion }) => {
  ...
  const { nombre, genero } = publicacion.creador
  const {
    aumentarLikes,
    aumentarDisLikes,
    restarLikes,
  ...
  return (
    <div className=' w-full  sm:w-10/12  2md:w-10/12 lg:w-6/12 xl:w-6/12   2xl:w-6/12 bg-gris-oscuro mx-auto pt-5 px-5 pb-2 md:rounded-md text-white mb-7  first-of-type:mb-0  md:mb-10'>
      ...
      <div className='flex  gap-7 mt-3 justify-between border-t border-slate-200 border-opacity-25 pt-1'>
        ...
        <div className='flex gap-2 items-center'>
          ...
          <p
            ...
            onClick={() => navigate(`/post/${publicacion._id}`)}
          >
            Comentarios
          </p>
        </div>
